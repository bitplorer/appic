# Grok Build prompt — APPIC on ux-compose 0.1.0 (kit-81)

Pin: [bitplorer/ux-compose](https://github.com/bitplorer/ux-compose) `@ main`
SHA **`5bb7dc22c9c9a3b9a732a1d180f346165b623b90`** (2026-09-09 kit-81 cut).
...
## 2026-09-09 — independent re-read

Re-walked `src/ux_compose/**/*.py` on **`5bb7dc22`**. Breaking cut vs the
...
ux-behavior `793f120`, ux-channel `31a60bd`, ux-motion `67ff3f0`,
...
(`5bb7dc22c9c9a3b9a732a1d180f346165b623b90`, **0.1.0**) as the **only** web UI
framework.
...
| **ux-channel** | Intent → Cap → Result. Behind compose `wire/` only | L2 | `31a60bd` `#subdirectory=python` |
...
1. Clone ux-compose `@ 5bb7dc22`. Python ≥ 3.14 venv. `pip install -e ".[serve]"`
