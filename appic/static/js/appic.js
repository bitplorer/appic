  ...
  function installBridge() {
    ...
    function report() {
      ...
      post({
        ...
        version: VERSION,
        type: "routes",
        paths: ["/", "/enter", "/desk", "/house", "/visit", "/signal", "/author", "/notes", "/overlay", "/copy", "/skin", "/deploy", "/atelier", "/commission", "/bag", "/board", "/studio", "/lab", "/lattice", "/trace", "/ledger", "/clocks", "/relay", "/health", "/pulse"],
      });
