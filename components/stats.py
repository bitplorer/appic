...
class Stats(Component):
    ...
    class_tile = "flex flex-col gap-1 rounded-2xl bg-ink-2 px-4 py-4"
    class_num = "m-0 font-display text-3xl font-semibold tracking-tight tabular-nums"
    class_btn = (
        "inline-flex min-h-11 cursor-pointer items-center justify-center rounded-full "
        "border border-hairline bg-raised px-5 text-sm font-medium"
    )
