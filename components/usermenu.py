...
class UserMenu(Component):
    ...
    class_trigger = (
        ...
        "border border-hairline bg-ink-2 px-3 text-left text-sm"
    )
    class_mark = (
        "flex h-8 w-8 items-center justify-center rounded-full bg-brass "
        "text-xs font-semibold text-brass-ink"
    )
    class_menu = (
