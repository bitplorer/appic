...
Open the table. Issue an intent (`⌘K`). Watch the document morph. Protected verbs mint Caps. Open **Lattice** to see authority as a constellation. Open **Trace** to see Ops as data.
...
| Lattice `/lattice` | Caps as seals. Intent as nucleus. Mint is a Cap. |
